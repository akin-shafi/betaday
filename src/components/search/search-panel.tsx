      ...
      try {
        ...
        if (backendResult && backendResult.confidence > localResult.confidence) {
          ...
          if (backendResult.businessType && backendResult.businessType !== localResult.businessType) {
            ...
            message.success(`🧠 AI enhanced: Found ${backendResult.businessType.toLowerCase()} category`)
    ...
    startListening(
      async (transcript) => {
        ...
        if (localResult.businessType) {
          ...
          message.success(`Voice search: Found ${localResult.businessType.toLowerCase()} category`)
