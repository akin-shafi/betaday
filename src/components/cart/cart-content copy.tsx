...
const CartContent: React.FC<CartContentProps> = ({
  ...
  const { address: contextAddress, isAddressValid, isLoading, error } = useAddress()
  ...
  // Use the custom hook for fee calculation
    ...
    <div className="h-full bg-white flex flex-col">
      ...
      <div className="flex-1">
        <div className="p-4 space-y-4">
          ...
          {feeError && <p className="text-red-500 text-sm text-center mt-2 animate-flash">{feeError}</p>}
